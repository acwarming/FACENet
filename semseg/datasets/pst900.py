...
class PST900(Dataset):
    ...
    num_classes: 5
    """
    CLASSES = ['background', 'frie-extinguisher', 'backpack', 'hand-drill', 'survivor']
    PALETTE = torch.tensor([[0,0,0],[0,0,255],[0,255,0],[255,0,0],[255,255,255]])
...
if __name__ == '__main__':
    traintransform = get_train_augmentation((720, 1280), seg_fill=255)

    trainset = PST900(transform=traintransform)
